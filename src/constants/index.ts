...
export const generateQuestionsPrompt = (
  ...
  Ignore images. Provide only the JSON array, nothing else. Be concise and fast. Your response should contain only a JSON array, nothing else but this array of objects with the above defined structure. If you are unable to do this then just return a text saying "unable to generate questions".
